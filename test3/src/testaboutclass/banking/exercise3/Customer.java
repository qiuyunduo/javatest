...
public class Customer {
    ...
    private testaboutclass.banking.exercise3.Account account;
    ...
    */
    ...
    public testaboutclass.banking.exercise3.Account getAccount() { return account; }
    //声明 setAccount 方法来对 account 属性赋值。
    public void setAccount(testaboutclass.banking.exercise3.Account account){ this.account = account; }
