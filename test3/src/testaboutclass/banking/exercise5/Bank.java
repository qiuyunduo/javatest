...
public class Bank {
    ...
    private testaboutclass.banking.exercise5.Customer[] customers;
    private int numberOfCustomers;

    //添加公有构造器，以合适的最大尺寸（至少大于 5）初始化 customers 数组。

    public Bank(){
        this.customers = new testaboutclass.banking.exercise5.Customer[10];
    }
    ...
    public void addCustomer(String f, String l){
        testaboutclass.banking.exercise5.Customer customer = new testaboutclass.banking.exercise5.Customer(f,l);
   ...
   */
    ...
    public testaboutclass.banking.exercise5.Customer getCustomer(int index) {
